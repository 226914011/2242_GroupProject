...
public class Withdrawal extends Transaction {
   ...
   private void displayWithdrawalMenu() {
      ...
      WithdrawalMenuHandler Handler = new WithdrawalMenuHandler();
      withdrawalMenu.getw100Button().addActionListener(Handler);
      withdrawalMenu.getw200Button().addActionListener(Handler);
      withdrawalMenu.getw500Button().addActionListener(Handler);
      withdrawalMenu.getw1000Button().addActionListener(Handler);
      withdrawalMenu.getwCustomButton().addActionListener(Handler);
      withdrawalMenu.getwCancelButton().addActionListener(Handler);
