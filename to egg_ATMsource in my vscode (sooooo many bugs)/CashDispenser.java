...
public class CashDispenser {
   ...
   public CashDispenser() { // set count attribute to default
   ...
   public int isSufficientCashAvailable(int amount) {
      if (amount % 100 != 0)
         return 1; // when user not input the multiple of 100, return 1
      if (amount > count_hundred * 100 + count_fivehundred * 500 + count_thousand * 1000)
         return 2;// that means there has not enough dollar note
      ...
      if (amount - thousand * 1000 > count_fivehundred * 500 + count_hundred * 100)
         return 3;// that means there has not enough 100$ dollar note or 500$ dollar note
      ...
      if (amount - thousand * 1000 - fivehundred * 500 > count_hundred * 100)
         return 4;// that means there has not enough 100$ dollar note
      return 5;
