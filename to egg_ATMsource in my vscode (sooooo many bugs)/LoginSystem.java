...
public class LoginSystem extends Screen {
	...
	public LoginSystem() {
		...
		// KeypadJPanel class
		KeypadJPanel keypadPanel = new KeypadJPanel(); // it need to be change to KeypadJPanel keypadPanel = new
														// KeypadJPanel();
		keypadPanel.setPreferredSize(new Dimension(550, 1024));
		super.getScreenContentPane().add(keypadPanel, BorderLayout.EAST); // this is sooooooooooooooooooooooooooooooo
																			// usefulllll, pls remember keypad should in
																			// BorderLayout.EAST
